...
if (isset($_POST['name'])){
 ...
 $_SESSION['error'] = "Mandatory field(s) are missing,fill again";
...
<html>
 <head>
 <title>Page2 Backgroud and Education Form</title>
 <link rel="stylesheet" href="style.css" />
 </head>
 <body>
 <div class="container">
 <div class="main">
 <h2>Backgroud and Education</h2><hr/>
 <span id="error">
<?php
...
?>
 ...
 <option value="">----Select----</options>
 <option value="new" value="">new </options>
 <option value="year" value=""> 2 year </options>
 <option value="Advanced" value="">4 year</options>
 </select>
